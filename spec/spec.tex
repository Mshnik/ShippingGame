...
\begin{enumerate}
\item Download the A6 files from the CMS.
\item Create a new Java project in Eclipse, named A6. 
\item Drag ShippingGame.jar and compressed folder data into your A6 folder, expand (unzip) the data folder. Don't change
the names of any of the folders within data or the code won?' be able to
find the data.
...
\begin{figure}[h]
\centerline{\includegraphics[scale=0.4]{collision.png}} 
